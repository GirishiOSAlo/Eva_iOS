...
//    static let companyList = baseURL + "user/companylist"
    ...
    static let eventConferenceStatus = baseURL + "event/conference_status"
    static let eventNetworkList = baseURL + "event/networkingeventlist"
    static let eventMeetingList = baseURL + "event/eventmeetinglists"
    static let eventNetworkingStatus = baseURL + "event/networking_status"
    static let eventDelegateMeetingStatus = baseURL + "event/changedelegatemeetingstatus"
    static let rescheduleEventMeeting = baseURL + "event/reschedulemeeting"
    static let speakerDetails = baseURL + "event/speakerDetials"
    ...
    static let meetingLists = baseURL + "meetings/meetinglists"
