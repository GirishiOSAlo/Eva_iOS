...
import Foundation
//DashboardEventDataModel
// MARK: - Welcome
struct DashboardEventDataModel: Codable {
    let error: Bool?
    let message: String?
    let data: [DashboardEventData]?
}

// MARK: - Datum
struct DashboardEventData: Codable {
    let id, userID: Int?
    ...
    let image: String?
    let newsSource: DashboardEventNewsSource?
    let isNewsSave: Int?
    let tempImage, tempImageUser: String?
    let user: DashboardEvent?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case isReceiver, content, title, filename
...
// MARK: - NewsSource
struct DashboardEventNewsSource: Codable {
    let id: Int?
    let name, status, image, url: String?
}

// MARK: - User
struct DashboardEvent: Codable {
    let id: Int?
