//
//  SuggestedConnectionModel.swift
//  EvaConnect
//
...
// MARK: - SuggetedConnectionDataModel
struct SuggetedConnectionDataModel: Codable {
    let error: Bool?
    let message: String?
    let data: [SuggestedConnection]?
}

// MARK: - Datum
struct SuggestedConnection: Codable {
    let id: Int?
    ...
    let language: String?
    let isPublic: Int?
    let userImageURL, createdAt, updatedAt: String?
