...
// MARK: - Welcome
class EventDelegateFilterRes: Codable {
    let error: Bool?
    let message: String?
    let data: [EventDelegateFilterList]?
}

// MARK: - Datum
class EventDelegateFilterList: Codable {
    let id: Int?
    ...
    let language: String?
    let isPublic: Int?
    let userImageURL, companyId : String?
